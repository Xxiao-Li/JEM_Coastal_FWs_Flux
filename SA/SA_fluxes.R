...
setwd("E:/00-Food web functioning and stability/Data_manuscript/SA")
info <- read.csv("SA_fluxweb.csv" ,fileEncoding = "UTF-8-BOM")
info

diet <- read.csv("SA_diet.csv", header = TRUE, fileEncoding = "UTF-8-BOM")
diet <- as.matrix(diet)
diet[is.na(diet)] <- 0
